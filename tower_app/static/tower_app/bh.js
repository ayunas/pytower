...
function renderFloors() {
  ...
  var container = document.querySelector(".board__floors");
  if (!container) return;
  ...
  var floorEnds = document.querySelectorAll("[data-floor-starts]");
  [].forEach.call(floorEnds, function(endEl) {
    JSON.parse(endEl.dataset.floorStarts).forEach(function(startNumber) {
      renderPath(
